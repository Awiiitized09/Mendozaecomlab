        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="http://localhost/wordpress/wp-content/uploads/2021/04/quitsmoke.png" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="main-header header-sticky">
                <div class="container-fluid">
                    <div class="menu-wrapper">
                        <!-- Logo -->
                        <div class="logo">
                            <a href="index.html"><img src="http://localhost/wordpress/wp-content/uploads/2021/04/quitsmoke.png" alt=""></a>
                        </div>
                        <!-- Main-menu -->
                        ...
                        <div class="row justify-content-between align-items-center">
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInLeft" data-delay=".4s" data-duration="2000ms">PUFF N' PASS VAPESHOP</h1>
                                    <p data-animation="fadeInLeft" data-delay=".7s" data-duration="2000ms">QUIT SMOKING START VAPING</p>
                                    <!-- Hero-btn -->
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 d-none d-sm-block">
                                <div class="hero__img" data-animation="bounceIn" data-delay=".4s">
                                    <img src="http://localhost/wordpress/wp-content/uploads/2021/04/vape1.png" alt="" class=" heartbeat">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="single-slider slider-height d-flex align-items-center slide-bg">
                    <div class="container">
                        <div class="row justify-content-between align-items-center">
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInLeft" data-delay=".4s" data-duration="2000ms">TAKE A HIT NOW</h1>
                                    <p data-animation="fadeInLeft" data-delay=".7s" data-duration="2000ms">ST. PETER LATER</p>
                                    <!-- Hero-btn -->
                                    <div class="hero__btn" data-animation="fadeInLeft" data-delay=".8s" data-duration="2000ms">
                                        <a href="industries.html" class="btn hero-btn">Shop Now</a>
                                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-new-pro mb-30 text-center">
                            <div class="product-img">
                                <img src="http://localhost/wordpress/wp-content/uploads/2021/04/product1.jpg" alt="">
                            </div>
                            <div class="product-caption">
                                <h3><a href="product_details.html">Aegis Boost (Pro)</a></h3>
                                <span>1,600</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-new-pro mb-30 text-center">
                            <div class="product-img">
                                <img src="http://localhost/wordpress/wp-content/uploads/2021/04/product2.jpg" alt="">
                            </div>
                            <div class="product-caption">
                                <h3><a href="product_details.html">Aegis Boost</a></h3>
                                <span> 1,300</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-new-pro mb-30 text-center">
                            <div class="product-img">
                                <img src="http://localhost/wordpress/wp-content/uploads/2021/04/product3.jpg" alt="">
                            </div>
                            <div class="product-caption">
                                <h3><a href="product_details.html">Aegis Boost (Limited Edition)</a></h3>
                                <span>1,400</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            <div class="gallery-img big-img" style="background-image: url(http://localhost/wordpress/wp-content/uploads/2021/04/extra1.jpeg);"></div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            <div class="gallery-img big-img" style="background-image: url(http://localhost/wordpress/wp-content/uploads/2021/04/extra2.jpeg);"></div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-12">
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-6 col-sm-6">
                                <div class="single-gallery mb-30">
                                    <div class="gallery-img small-img" style="background-image: url(http://localhost/wordpress/wp-content/uploads/2021/04/extra3.jpeg);"></div>
                                </div>
                            </div>
                            <div class="col-xl-12 col-lg-12  col-md-6 col-sm-6">
                                <div class="single-gallery mb-30">
                                    <div class="gallery-img small-img" style="background-image: url(http://localhost/wordpress/wp-content/uploads/2021/04/extra4.jpeg);"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-7 col-lg-8 col-md-10">
                        <div class="section-tittle mb-70 text-center">
                            <h2>Popular Items</h2>
                            <p> WE ARE GIVING YOU THE CHEAPEST VAPORIZER AROUND THE CITY</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-popular-items mb-50 text-center">
                            <div class="popular-img">
                                <img src="http://localhost/wordpress/wp-content/uploads/2021/04/p1.jpg" alt="">
                                <div class="img-cap">
                            ...
                            <div class="popular-caption">
                                <h3><a href="product_details.html">Bersikulo uno</a></h3>
                                <span> 3,500 </span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-popular-items mb-50 text-center">
                            <div class="popular-img">
                                <img src="http://localhost/wordpress/wp-content/uploads/2021/04/p2.jpg" alt="">
                                <div class="img-cap">
                                    <span>Add to cart</span>
                                </div>
                                <div class="favorit-items">
                            ...
                            <div class="popular-caption">
                                <h3><a href="product_details.html">Aegis Legend</a></h3>
                                <span> 2,000 </span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-popular-items mb-50 text-center">
                            <div class="popular-img">
                                <img src="http://localhost/wordpress/wp-content/uploads/2021/04/p3.jpg" alt="">
                                <div class="img-cap">
                                    <span>Add to cart</span>
                                </div>
                                <div class="favorit-items">
                            ...
                            <div class="popular-caption">
                                <h3><a href="product_details.html">Aegis Solo</a></h3>
                                <span> 1,400 </span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-popular-items mb-50 text-center">
                            <div class="popular-img">
                                <img src="http://localhost/wordpress/wp-content/uploads/2021/04/p4.jpg" alt="">
                                <div class="img-cap">
                                    <span>Add to cart</span>
                                </div>
                                <div class="favorit-items">
                            ...
                            <div class="popular-caption">
                                <h3><a href="product_details.html">Voopoo Drag X</a></h3>
                                <span>$ 1,600 /span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-popular-items mb-50 text-center">
                            <div class="popular-img">
                                <img src="http://localhost/wordpress/wp-content/uploads/2021/04/p5.png" alt="">
                                <div class="img-cap">
                                    <span>Add to cart</span>
                                </div>
                                <div class="favorit-items">
                            ...
                            <div class="popular-caption">
                                <h3><a href="product_details.html">Relx Infinity</a></h3>
                                <span> 1,200 </span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-popular-items mb-50 text-center">
                            <div class="popular-img">
                                <img src="http://localhost/wordpress/wp-content/uploads/2021/04/p6.png" alt="">
                                <div class="img-cap">
                                    <span>Add to cart</span>
                                </div>
                                <div class="favorit-items">
                            ...
                            <div class="popular-caption">
                                <h3><a href="product_details.html">Snowplus (Pro)</a></h3>
                                <span> 1,900 </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="video-wrap">
                        <div class="play-btn "><a class="popup-video" href="https://www.youtube.com/watch?v=SR2YMZiJPe8"><i class="fas fa-play"></i></a></div>
                    </div>
                    </div>
                </div>
                <!-- Arrow -->
        ...
        <div class="watch-area section-padding30">
            <div class="container">
                <div class="row align-items-center justify-content-between padding-130">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-10">
                        <div class="choice-watch-img mb-40">
                            <img src="http://localhost/wordpress/wp-content/uploads/2021/04/cw1.jpg" alt="">
                        </div>
                    </div>
                </div>
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-6 col-md-6 col-sm-10">
                        <div class="choice-watch-img mb-40">
                            <img src="http://localhost/wordpress/wp-content/uploads/2021/04/cw2-1.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-lg-5 col-md-6">
                        <div class="watch-details mb-40">
                            <h2>FUEL AUTOMIZER</h2>
                            <p></p>
                            <a href="shop.html" class="btn">Show Watches</a>
                        </div>
                    </div>
